...
ax.plot(avg['t'], np.fabs(np.fabs(avg['Edot']) - np.fabs(avg['Mdot'])), color='k')
if diags: ax.plot(avg['t_d'], np.fabs(np.fabs(avg['Edot_d']) - np.fabs(avg['Mdot_d'])), linestyle='--', color='r')
ax.set_xlim([0,1e4])
ax.set_xticklabels([])
...
ax = plt.subplot(5,1,4)
ax.plot(avg['t'], np.fabs(np.fabs(avg['Edot']) - np.fabs(avg['Mdot']))/(np.fabs(avg['Mdot'])), color='k')
if diags: ax.plot(avg['t_d'], np.fabs(np.fabs(avg['Edot_d']) - np.fabs(avg['Mdot_d']))/(np.fabs(avg['Mdot_d'])), linestyle='--', color='r')
ax.set_xlim([0,1e4])
ax.set_xticklabels([])
