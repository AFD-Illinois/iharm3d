  ...
  for i in xrange(hdr['N1']):
    ...
    for j in xrange(hdr['N2']):
      for k in xrange(hdr['N3']):
        Thetae_sadw[i] += dump['Thetae'][i,j,k]*dump['RHO'][i,j,k]*dump['gdet'][i,j,k]*hdr['dx1']*hdr['dx2']*hdr['dx3']
        sigma[i] += dump['RHO'][i,j,k]*hdr['dx2']*dump['gdet'][i,j,k]
        mdot[i] += dump['RHO'][i,j,k]*
        vol += dump['RHO'][i,j,k]*dump['gdet'][i,j,k]*hdr['dx1']*hdr['dx2']*hdr['dx3']
