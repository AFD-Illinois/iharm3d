...
if diags: ax.plot(avg['t_d'], np.fabs(avg['Edot_d'] - avg['Mdot_d']), linestyle='--', color='r')
ax.set_xlim([0,1e4])
ax.set_xticklabels([])
...
if diags: ax.plot(avg['t_d'], np.fabs(avg['Edot_d'] - avg['Mdot_d'])/(np.fabs(avg['Mdot_d'])), linestyle='--', color='r')
ax.set_xlim([0,1e4])
ax.set_xticklabels([])
