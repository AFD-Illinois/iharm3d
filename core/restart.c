...
void restart_write(struct FluidState *S)
{
  ...
  hdf5_write_single_val(&nstep, "nstep", H5T_NATIVE_INT);
  hdf5_write_single_val(&tf, "tf", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&gam, "gam", H5T_NATIVE_DOUBLE);
  #if ELECTRONS
  hdf5_write_single_val(&game, "game", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&gamp, "gamp", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&fel0, "fel0", H5T_NATIVE_DOUBLE);
  #endif
  hdf5_write_single_val(&cour, "cour", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&DTd, "DTd", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&DTf, "DTf", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&DTl, "DTl", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&DTr, "DTr", H5T_NATIVE_INT);
  hdf5_write_single_val(&DTp, "DTp", H5T_NATIVE_INT);
  ...
  hdf5_write_single_val(&x2Min, "x2Min", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&x2Max, "x2Max", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&x3Min, "x3Min", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&x3Max, "x3Max", H5T_NATIVE_DOUBLE);
#endif
  hdf5_write_single_val(&tdump, "tdump", H5T_NATIVE_DOUBLE);
  hdf5_write_single_val(&tlog, "tlog", H5T_NATIVE_DOUBLE);
  ...
  hdf5_write_array(S->P, "p", 4, fdims, fstart, fcount, mdims, mstart, H5T_NATIVE_DOUBLE);
...
void restart_read(char *fname, struct FluidState *S)
{
  ...
  int n1, n2, n3;
  hdf5_read_single_val(&n1, "n1", H5T_NATIVE_INT);
  hdf5_read_single_val(&n2, "n2", H5T_NATIVE_INT);
  hdf5_read_single_val(&n3, "n3", H5T_NATIVE_INT);
  if(n1 != N1TOT || n2 != N2TOT || n3 != N3TOT) {
    if (mpi_io_proc()) fprintf(stderr, "Restart file is wrong size!\n");
    exit(-1);
  }

  hdf5_read_single_val(&t, "t", H5T_NATIVE_DOUBLE);
  hdf5_read_single_val(&nstep, "nstep", H5T_NATIVE_INT);
  hdf5_read_single_val(&gam, "gam", H5T_NATIVE_DOUBLE);
  #if ELECTRONS
  hdf5_read_single_val(&game, "game", H5T_NATIVE_DOUBLE);
  hdf5_read_single_val(&gamp, "gamp", H5T_NATIVE_DOUBLE);
  hdf5_read_single_val(&fel0, "fel0", H5T_NATIVE_DOUBLE);
  #endif
...
//  hdf5_read_single_val(&DTl, "DTl", H5T_NATIVE_DOUBLE);
//  hdf5_read_single_val(&DTr, "DTr", H5T_NATIVE_INT);
//  hdf5_read_single_val(&DTp, "DTp", H5T_NATIVE_INT);
  ...
  hdf5_read_single_val(&a, "a", H5T_NATIVE_DOUBLE);
  ...
  hdf5_read_single_val(&x2Min, "x2Min", H5T_NATIVE_DOUBLE);
  hdf5_read_single_val(&x2Max, "x2Max", H5T_NATIVE_DOUBLE);
  hdf5_read_single_val(&x3Min, "x3Min", H5T_NATIVE_DOUBLE);
  hdf5_read_single_val(&x3Max, "x3Max", H5T_NATIVE_DOUBLE);
#endif
  hdf5_read_single_val(&tdump, "tdump", H5T_NATIVE_DOUBLE);
  hdf5_read_single_val(&tlog, "tlog", H5T_NATIVE_DOUBLE);

  // Read data
  hsize_t fstart[] = {0, global_start[2], global_start[1], global_start[0]};
  hdf5_read_array(S->P, "p", 4, fdims, fstart, fcount, mdims, mstart, H5T_NATIVE_DOUBLE);
